...
public class TinderBoltApp extends MultiSessionTelegramBot {
    public static final String TELEGRAM_BOT_NAME = "WebinarTinderAI_bot"; //TODO: добавь имя бота в кавычках
    public static final String TELEGRAM_BOT_TOKEN = "7399392777:AAFHdZV1gaeKFioB2tA1tR11h-d5RsaF95Q"; //TODO: добавь токен бота в кавычках
        ...
        if (currentMode == DialogMode.PROFILE && !isMessageCommand()) {
            switch (questionCount) {
                ...
                case 2:
                    ...
                    questionCount = 3;
                    sendTextMessage("Если у вас хобби?");
                    return;
                case 3:
                    me.hobby = message;
                    questionCount = 4;
